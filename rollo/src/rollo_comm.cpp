...
// Global variables updated in the @p subscriberCallback() function, processed and used to send commands to the specified @p ip adress at the UDP @p port.
...
char ip[16] = "192.168.0.120"; //!< Rollo ip address hardcoded
...
int v_l; //!< Velocity for left wheel
int v_r; //!< Velocity for right wheel
...
int VelocityL; //!< Message left wheel velocity description
int VelocityR; //!< Message right wheel velocity description
